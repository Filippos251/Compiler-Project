...
ΠΕΡΙΣΣΟΤΕΡΑ ΓΙΑ Σ.Α.
CONFLICTS
φαίνονται στα states δηλαδή στο .output file !!!
...
ERRORS Σφάλματα Συντακτικής ανάλυσης !!
...
Ο κώδικας {} στο κομμάτι της γραμματικής έχει σημασία σε ποιο σημείο θα μπει
Μπορεί να μπει ανάμεσα στις δηλώσεις, αν πρέπει να κάνω κάτι τύπου {scope++;}

Μία μεταβλητή έχει scope 0 όταν είναι global

ΔΗΜΙΟΥΡΓΕΊΑ HASHTABLE // τα παίρνω έτοιμα από μία διαθέσιμη βιβλιοθήκη 
hashtbl.h
έτοιμος κώδικας, να συμπεριλάβω το λινκ στη βιβλιογραφεία. Χρειάζομαι τις συναρτήσεις hashtbl_get, hashtbl_insert, hashtbl_destroy // τις δημιουργώ στο .c file

SCOPES 
όταν ορίζω μία συνάρτηση κάνω scope++ 
